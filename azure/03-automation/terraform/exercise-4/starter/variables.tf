...
# TODO: Add variable for database admin username
...
# TODO: Add variable for database admin password
# IMPORTANT: Mark as sensitive!
...
# TODO: Add variable for app service SKU
...
# TODO: Add variable for app settings (optional)
